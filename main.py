...
def extract_price_data(product_soup): try: list_price_tag = product_soup.select_one('.a-text-price .a-offscreen') list_price = list_price_tag.get_text(strip=True) if list_price_tag else None
...
for deal in deals:
    try:
        ...
        if title_tag and link_tag:
            ...
            # TEMP: Force-post all detected deals for testing
...
if not deals:
    print("[INFO] No discounted deals found today.")
else:
